package ca.bc.gov.educ.api.coreg;
...
@EnableScheduling
public class CoRegApiResourceApplication {
  /**
  ...
  public static void main(String[] args) {
    SpringApplication.run(CoRegApiResourceApplication.class, args);
  }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
      http
        ...
        .authorizeHttpRequests(auth -> auth
          .requestMatchers("/v1/api-docs-ui.html",
                  "/v1/api-docs/**",
                  "/actuator/health",
                  "/actuator/prometheus",
                  "/actuator/**",
