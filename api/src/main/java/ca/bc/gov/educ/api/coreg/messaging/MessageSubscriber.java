package ca.bc.gov.educ.api.coreg.messaging;

import ca.bc.gov.educ.api.coreg.messaging.jetstream.Subscriber;
import ca.bc.gov.educ.api.coreg.service.v1.EventHandlerDelegatorService;
...
import static ca.bc.gov.educ.api.coreg.constants.v1.Topics.COREG_API_TOPIC;
...
public class MessageSubscriber {
    ...
    public void subscribe() {
        String queue = COREG_API_TOPIC.toString().replace("_", "-");
        var dispatcher = connection.createDispatcher(onMessage());
        dispatcher.subscribe(COREG_API_TOPIC.toString(), queue);
    }
