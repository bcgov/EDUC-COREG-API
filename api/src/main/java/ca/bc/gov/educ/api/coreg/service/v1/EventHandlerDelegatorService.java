...
import ca.bc.gov.educ.api.coreg.messaging.MessagePublisher;
...
import static ca.bc.gov.educ.api.coreg.service.v1.EventHandlerService.PAYLOAD_LOG;
        ...
        try {
            switch (event.getEventType()) {
                case GET_COURSE_FROM_EXTERNAL_ID:
                    ...
                    response = eventHandlerService.handleGetCourseFromExternalIDEvent(event, isSynchronous);
