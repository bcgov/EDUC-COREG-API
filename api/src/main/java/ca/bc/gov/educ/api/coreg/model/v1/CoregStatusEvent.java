...
public class CoregStatusEvent {
     ...
     */
    public static class COREGStatusEventBuilder {
        /**
        ...
        /**
         * Event payload COREG status event . COREGStatus event builder.
         *
         * @param eventPayload the event payload
         * @return the student event . student event builder
         */
        public COREGStatusEventBuilder eventPayload(String eventPayload) {
