...
public interface CourseInformationAPIEndpoint {
  ...
  @Operation(summary = "Download Courses Report", description = "Download a CSV report of courses")
  void getCoursesReport(HttpServletResponse response) throws IOException;
}
