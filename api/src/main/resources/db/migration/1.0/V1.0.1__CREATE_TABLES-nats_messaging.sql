-- API_COURSE_REG.COREG_COURSE_EVENT definition

CREATE TABLE "COREG_COURSE_EVENT"
...
CREATE INDEX "EVENT_STATUS_IDX" ON "COREG_COURSE_EVENT" ("EVENT_STATUS")
TABLESPACE "API_GRAD_IDX";

CREATE INDEX "EVENT_TYPE_IDX" ON "COREG_COURSE_EVENT" ("EVENT_TYPE")
TABLESPACE "API_GRAD_IDX";

COMMENT ON TABLE COREG_COURSE_EVENT IS 'This table is used to store all the received choreographed events from different api via pub/sub model and process them.';

GRANT SELECT ON COREG_COURSE_EVENT TO GRAD_READONLY;
